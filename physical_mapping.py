    ...
    for z in range(im.n_frames):
        ...
        for x in range(rgb_im.size[0]):
            for y in range(rgb_im.size[1]):
                newMap[x, y] = tuple(closest(rgb_im.getpixel((x,y))))
